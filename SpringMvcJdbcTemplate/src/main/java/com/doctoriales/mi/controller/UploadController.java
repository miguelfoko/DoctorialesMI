...
System.out.println("1++++++++");
	...
	public String uploadArticleGetCC(Model model, HttpServletRequest req) {
		...
		operationResult="Upload réussie, Mais notification non envoyé à cause d'un problème lié au serveur de mail";
		req.setAttribute("operationResult", operationResult);
		return "interUpload";
	}
	...
	public String uploadArticleGetDD(Model model, HttpServletRequest req) {
		...
		operationResult="Echec de l'opération, Probl_me de connexion à la Base de Données";
		req.setAttribute("operationResult", operationResult);
		return "interUpload";
	}
