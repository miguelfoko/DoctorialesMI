				...
				<form action="<c:url value='registration'/>" method="post"
					...
					<div class="form-group">
						<label for="lastName">Nom:</label> <input class="form-control"
							...
							onkeyup='nom()' />
							<span class="erreur">${regis.erreurs['nom']}</span>
					</div>
					<div class="form-group">
						<label for="firstName">Prenom:</label> <input class="form-control"
							type="text" name="firstName" size="50" id="firstName"
							required/ onkeyup='prenom()'><span class="erreur">${regis.erreurs['prenom']}</span><br>

					</div>
					<div class="form-group">
						<label class="form-label col-xs-2" for="mail">Email:</label> <input
							class="form-control" type="text" size="50" required name="email">
							<span class="erreur">${regis.erreurs['email']}</span><br>
					</div>
					<div class="form-group">
						<label for="password">Password:</label> <input
							class="form-control" type="password" name="password" size="50"
							id="password" required/ onkeyup='prenom()'>
							<span class="erreur">${regis.erreurs['password']}</span><br>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="form-label col-xs-4" for="laboratoire">Laboratoire:
							...
							<span class="erreur">${regis.erreurs['labo']}</span>
					</div>
					<div class="form-group">
